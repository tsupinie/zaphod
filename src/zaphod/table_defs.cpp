...
Grib2Table<Grib2TableEntryUnitsAbbrev> Grib2TableManager::get_table_4_2(unsigned short discipline, unsigned short category) const {
    std::map<std::string, Grib2Table<Grib2TableEntryUnitsAbbrev>> tables({
        {"0.0", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {19, "turbulent transfer coefficient for hea", "", "TTCHT"},
            ...
            {194, "relative error varianc", "", "REV"},
        ...
        {"0.1", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {30, "precipitable water categor", "", "PWCAT"},
            {31, "", "m", "HAIL"},
            {32, "graupel", "kg kg-1", "GRLE"},
            {33, "categorical rai", "", "CRAIN"},
            {34, "categorical freezing rai", "", "CFRZR"},
            {35, "categorical ice pellet", "", "CICEP"},
            {36, "categorical sno", "", "CSNOW"},
            ...
            {88, "categorical convective precipitatio", "", "CATCP"},
            ...
            {122, "precipitation intensity inde", "", "PIIDX"},
            {123, "dominant precipitation typ", "", "DPTYPE"},
            {124, "presence of shower", "", "PSHOW"},
            {125, "presence of blowing sno", "", "PBSNOW"},
            {126, "presence of blizzar", "", "PBLIZZ"},
            ...
            {137, "effective aspect ratio of rai", "", "EFARRAIN"},
            {138, "effective aspect ratio of cloud ic", "", "EFARCICE"},
            {139, "effective aspect ratio of sno", "", "EFARSNOW"},
            {140, "effective aspect ratio of graupe", "", "EFARGRL"},
            {141, "effective aspect ratio of hai", "", "EFARHAIL"},
            {142, "effective aspect ratio of subgrid ice cloud", "", "EFARSIC"},
            ...
            {147, "character of precipitatio", "", "CHPRECIP"},
            ...
            {192, "categorical rai", "", "CRAIN"},
            {193, "categorical freezing rai", "", "CFRZR"},
            {194, "categorical ice pellet", "", "CICEP"},
            {195, "categorical sno", "", "CSNOW"},
            ...
            {202, "rain fraction of total liquid wate", "", "FRAIN"},
            {203, "rime facto", "", "RIME"},
            {204, "total column integrated rain", "kg m-2", "TCOLR"},
            {205, "total column integrated snow", "kg m-2", "TCOLS"},
            {206, "total icing potential diagnosti", "", "TIPD"},
            {207, "number concentration for ice particle", "", "NCIP"},
        ...
        {"0.2", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {60, "drag thermal coefficien", "", "DTC"},
            {61, "drag evaporation coefficien", "", "DEC"},
            ...
            {218, "velocity point model surfac", "", "LMV"},
        ...
        {"0.3", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {22, "slope of subgrid scale orograph", "", "SSGSO"},
            {23, "gravity wave dissipation", "W m-2", "GWD"},
            {24, "anisotropy of subgrid scale orograph", "", "ASGSO"},
            {25, "natural logarithm of pressure in p", "", "NLPRES"},
            {26, "exner pressur", "", "EXPRES"},
            ...
            {31, "unbalanced component of logarithm of surface pressur", "", "UCLSPRS"},
            ...
            {210, "mass point model surfac", "", "LMH"},
            {211, "geopotential height", "gpm", "HGTN"},
            {212, "pressure", "Pa", "PRESN"},
            {213, "orographic convexit", "", "ORCONV"},
            {214, "orographic asymmetry, w componen", "", "ORASW"},
            {215, "orographic asymmetry, s componen", "", "ORASS"},
            {216, "orographic asymmetry, sw componen", "", "ORASSW"},
            {217, "orographic asymmetry, nw componen", "", "ORASNW"},
            {218, "orographic length scale, w componen", "", "ORLSW"},
            {219, "orographic length scale, s componen", "", "ORLSS"},
            {220, "orographic length scale, sw componen", "", "ORLSSW"},
            {221, "orographic length scale, nw componen", "", "ORLSNW"},
        ...
        {"0.6", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {32, "fraction of cloud cove", "", "FRACCC"},
            {33, "sunshine duration", "s", "SUNSD"},
            {34, "surface long wave effective total cloudines", "", "SLWTC"},
            {35, "surface short wave effective total cloudines", "", "SSWTC"},
            ...
            {47, "volume fraction of cloud water droplet", "", "VFRCWD"},
            {48, "volume fraction of cloud ice particle", "", "VFRCICE"},
            {49, "volume fraction of clou", "", "VFRCIW"},
            {50, "", "%", "FOG"},
            {51, "sunshine duration fraction", "Proportion", "SUNFRAC"},
            {192, "non-convective cloud cover", "%", "CDLYR"},
            {193, "cloud work function", "J kg-1", "CWORK"},
            {194, "convective cloud efficienc", "", "CUEFI"},
            ...
            {199, "ice fraction of total condensat", "", "FICE"},
        ...
        {"0.7", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {9, "energy helicity inde", "", "EHLX"},
            {10, "surface lifted index", "K", "LFTX"},
            {11, "best lifted index", "K", "4LFTX"},
            {12, "richardson numbe", "", "RI"},
            {13, "showalter index", "K", "SHWINX"},
            {15, "updraft helicity", "m2 s-2", "UPHL"},
            {16, "bulk richardson numbe", "", "BLKRN"},
            {17, "gradient richardson numbe", "", "GRDRN"},
            {18, "flux richardson numbe", "", "FLXRN"},
            {19, "convective available potential energy - shear", "m2 s-2", "CONAPES"},
            {20, "thunderstorm intensity inde", "", "TIIDEX"},
            {21, "storm severity inde", "", "SSI"},
            ...
            {194, "richardson numbe", "", "RI"},
            {195, "convective weather detection inde", "", "CWDI"},
            {196, "ultra violet index", "W m-2", "UVI"},
            {197, "updraft helicity", "m2 s-2", "UPHL"},
            {198, "leaf area inde", "", "LAI"},
            ...
            {205, "enhanced stretching potentia", "", "ESP"},
        ...
        {"0.15", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {6, "radar spectr", "", "RDSP1"},
            {7, "radar spectr", "", "RDSP2"},
            {8, "radar spectr", "", "RDSP3"},
            ...
            {19, "radar data quality fla", "", "RDQF"},
        ...
        {"0.19", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {12, "planetary boundary layer regim", "", "PBLREG"},
            {13, "contrail intensit", "", "CONTI"},
            {14, "contrail engine typ", "", "CONTET"},
            ...
            {25, "weathe", "", "WIWW"},
            {26, "convective outloo", "", "CONVO"},
            {27, "icing scenari", "", "ICESC"},
            ...
            {36, "presence of snow squall", "", "PSNOWS"},
            {37, "icing severit", "", "ICESEV"},
            {38, "sky transparency inde", "", "SKYIDX"},
            {39, "seeing inde", "", "SEEINDEX"},
            ...
            {203, "categorical thunderstor", "", "TSTMC"},
            {204, "number of mixed layers next to surface", "integer", "MIXLY"},
            {205, "flight categor", "", "FLGHT"},
            {206, "confidence - ceilin", "", "CICEL"},
            {207, "confidence - visibilit", "", "CIVIS"},
            {208, "confidence - flight categor", "", "CIFLT"},
            {209, "low-level aviation interes", "", "LAVNI"},
            {210, "high-level aviation interes", "", "HAVNI"},
            ...
            {217, "supercooled large drople", "", "SIPD"},
            {218, "radiative emissivit", "", "EPSR"},
            {219, "turbulence potential forecast inde", "", "TPFI"},
            {220, "categorical severe thunderstor", "", "SVRTS"},
            {221, "probability of convection", "%", "PROCON"},
            {222, "convection potentia", "", "CONVP"},
            {223, "tornado conditional intensity group", "", "CIGTOR"},
            {224, "hail conditional intensity group", "", "CIGHAIL"},
            {225, "wind conditional intensity group", "", "CIGWIND"},
            {226, "total severe conditional intensity group", "", "CIGSVR"},
            {232, "volcanic ash forecast transport and dispersion", "log10", "VAFTD"},
            {233, "icing probabilit", "", "ICPRB"},
            {234, "icing severit", "", "ICSEV"},
            {235, "joint fire weather probability", "%", "JFWPRB"},
            {236, "snow level", "m", "SNOWLVL"},
            {237, "dry thunderstorm probability", "%", "DRYTPROB"},
            {238, "ellrod inde", "", "ELLINX"},
            {239, "craven-wiedenfeld aggregate severe paramete", "", "CWASP"},
            {240, "continuous icing severit", "", "ICESEVCON"},
            {255, "missi", "", ""},
        }, "")},
        {"0.20", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {102, "aerosol optical thicknes", "", "AOTK"},
            {103, "single scattering albed", "", "SSALBK"},
            {104, "asymmetry facto", "", "ASYSFK"},
            ...
            {111, "angstrom exponen", "", "ANGSTEXP"},
            {112, "absorption aerosol optical thicknes", "", "SCTAOTK"},
        ...
        {"0.191", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {4, "tropical cyclone density trac", "", "TCDTRACK"},
        ...
        {"1.0", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {2, "remotely sensed snow cove", "", "RSSC"},
            {3, "elevation of snow-covered terrai", "", "ESCT"},
            ...
            {194, "flood hazard outloo", "", "FHO"},
            {196, "area hydrologic discussio", "", "AHD"},
            {255, "missi", "", ""},
        }, "")},
        {"1.1", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {196, "binary probability of precipitation exceeding average recurrence intervals see code table 4.22", "", "QPFARI"},
            {197, "binary probability of precipitation exceeding flash flood guidance values see code table 4.22", "", "QPFFFG"},
            {255, "missi", "", ""},
        }, "")},
        {"1.2", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {9, "shape factor with respect to salinity profil", "", "SFSAL"},
            {10, "shape factor with respect to temperature profile in thermoclin", "", "SFTMP"},
        ...
        {"2.0", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {57, "type of low-vegetatio", "", "TYPLOVEG"},
            {58, "type of high-vegetatio", "", "TYPHIVEG"},
            ...
            {206, "rate of water dropping from canopy to groun", "", "RDRIP"},
            ...
            {217, "normalized difference vegetation inde", "", "NDVI"},
        ...
        {"2.1", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            {192, "cold advisory for newborn livestoc", "", "CANL"},
            {255, "missi", "", ""},
        }, "")},
        {"2.3", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {6, "number of soil layers in root zon", "", "RLYRS"},
            ...
            {30, "soil wetness inde", "", "SWET"},
            {192, "liquid volumetric soil moisture", "Proportion", "SOILL"},
            {193, "number of soil layers in root zon", "", "RLYRS"},
        ...
        {"2.4", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            {0, "fire outloo", "", "FIREOLK"},
            {1, "fire outlook due to dry thunderstor", "", "FIREODT"},
            {2, "haines inde", "", "HINDEX"},
            {3, "fire burned area", "%", "FBAREA"},
            {4, "fosberg inde", "", "FOSINDX"},
            {5, "forest fire weather inde", "", "FWINX"},
            {6, "fine fuel moisture cod", "", "FFMCODE"},
            {7, "duff moisture cod", "", "DUFMCODE"},
            {8, "drought cod", "", "DRTCODE"},
            {9, "initial fire spread inde", "", "INFSINX"},
            {10, "fire buildup inde", "", "FBUPINX"},
            {11, "fire daily severity ratin", "", "FDSRTE"},
            {12, "keetch-byram drought inde", "", "KRIDX"},
            {13, "drought facto", "", "DRFACT"},
            {14, "rate of spread", "m s-1", "RATESPRD"},
            {15, "fire danger inde", "", "FIREDIDX"},
            {16, "spread componen", "", "SPRDCOMP"},
            {17, "burning inde", "", "BURNIDX"},
        ...
        {"3.0", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            {0, "scaled radianc", "", "SRAD"},
            {1, "scaled albed", "", "SALBEDO"},
            {2, "scaled brightness temperatur", "", "SBTMP"},
            {3, "scaled precipitable wate", "", "SPWAT"},
            {4, "scaled lifted inde", "", "SLFTI"},
            {5, "scaled cloud top pressur", "", "SCTPRES"},
            {6, "scaled skin temperatur", "", "SSTMP"},
            {7, "cloud mas", "", "CLOUDM"},
            {8, "pixel scene typ", "", "PIXST"},
            {9, "fire detection indicato", "", "FIREDI"},
            {255, "missi", "", ""},
        }, "")},
        {"3.1", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {20, "aerosol optical thickness at 0.635 µ", "", "AOT06"},
            {21, "aerosol optical thickness at 0.810 µ", "", "AOT08"},
            {22, "aerosol optical thickness at 1.640 µ", "", "AOT16"},
            {23, "angstrom coefficien", "", "ANGCOE"},
            {24, "cosine of the solar zenith angl", "", "COSOLZA"},
            {27, "bidirectional reflecance facto", "", "BRFLF"},
            {28, "brightness temperature", "K", "SPBRT"},
            {29, "scaled radianc", "", "SCRAD"},
            {30, "reflectance in 0.4 micron channel", "%", "RFL04"},
            {31, "cloudy reflectance", "%", "CLDREF"},
            {32, "clear reflectance", "%", "CLRREF"},
            {98, "correlation coefficient between mpe rain rates for the co-located ir data and the microwave data rain rate", "", "CCMPEMRR"},
            {99, "standard deviation between mpe rain rates for the co-located ir data and the microwave data rain rate", "", "SDMPEMRR"},
            {192, "scatterometer estimated u wind component", "m s-1", "USCT"},
            {193, "scatterometer estimated v wind component", "m s-1", "VSCT"},
            {194, "scatterometer wind qualit", "", "SWQI"},
            {255, "missi", "", ""},
        }, "")},
        {"3.2", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {3, "cloud typ", "", "CLDTYPE"},
            {4, "cloud phas", "", "CLDPHAS"},
            {5, "cloud optical dept", "", "CLDODEP"},
            {6, "cloud particle effective radius", "m", "CLDPER"},
            {7, "cloud liquid water path", "kg m-2", "CLDLWP"},
            {8, "cloud ice water path", "kg m-2", "CLDIWP"},
            {9, "cloud albed", "", "CLDALB"},
            {10, "cloud emissivit", "", "CLDEMISS"},
            {11, "effective absorption optical depth rati", "", "EAODR"},
            {30, "measurement cos", "", "MEACST"},
            {31, "upper layer cloud optical dep", "", ""},
            {32, "upper layer cloud top pressur", "P", ""},
            {33, "upper layer cloud effective radi", "", ""},
            {34, "error in upper layer cloud optical dep", "", ""},
            {35, "error in upper layer cloud top pressur", "P", ""},
            {36, "error in upper layer cloud effective radi", "", ""},
            {37, "lower layer cloud optical dep", "", ""},
            {38, "lower layer cloud top pressur", "P", ""},
            {39, "error in lower layer cloud optical dep", "", ""},
            {40, "error in lower layer cloud top pressur", "P", ""},
            {255, "missi", "", ""},
        }, "")},
        ...
        {"3.4", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {4, "volcanic ash cloud emissit", "", "VOLACDEM"},
            {5, "volcanic ash effective absorption depth rati", "", "VOLAEADR"},
            {6, "volcanic ash cloud optical dept", "", "VOLACDOD"},
        ...
        {"3.192", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {14, "simulated reflectance factor for abi goes-16, band-", "", "SRFA161"},
            {15, "simulated reflectance factor for abi goes-16, band-", "", "SRFA162"},
            {16, "simulated reflectance factor for abi goes-16, band-", "", "SRFA163"},
            {17, "simulated reflectance factor for abi goes-16, band-", "", "SRFA164"},
            {18, "simulated reflectance factor for abi goes-16, band-", "", "SRFA165"},
            {19, "simulated reflectance factor for abi goes-16, band-", "", "SRFA166"},
            ...
            {30, "simulated reflectance factor for abi goes-17, band-", "", "SRFA171"},
            {31, "simulated reflectance factor for abi goes-17, band-", "", "SRFA172"},
            {32, "simulated reflectance factor for abi goes-17, band-", "", "SRFA173"},
            {33, "simulated reflectance factor for abi goes-17, band-", "", "SRFA174"},
            {34, "simulated reflectance factor for abi goes-17, band-", "", "SRFA175"},
            {35, "simulated reflectance factor for abi goes-17, band-", "", "SRFA176"},
            ...
            {46, "simulated reflectance factor for nadir abi goes-r, band-", "", "SRFAGR1"},
            {47, "simulated reflectance factor for nadir abi goes-r, band-", "", "SRFAGR2"},
            {48, "simulated reflectance factor for nadir abi goes-r, band-", "", "SRFAGR3"},
            {49, "simulated reflectance factor for nadir abi goes-r, band-", "", "SRFAGR4"},
            {50, "simulated reflectance factor for nadir abi goes-r, band-", "", "SRFAGR5"},
            {51, "simulated reflectance factor for nadir abi goes-r, band-", "", "SRFAGR6"},
            {52, "simulated brightness temperature for nadir abi goes-r, band-", "", "SBTAGR7"},
            {53, "simulated brightness temperature for nadir abi goes-r, band-", "", "SBTAGR8"},
            {54, "simulated brightness temperature for nadir abi goes-r, band-", "", "SBTAGR9"},
            {55, "simulated brightness temperature for nadir abi goes-r, band-1", "", "SBTAGR10"},
            {56, "simulated brightness temperature for nadir abi goes-r, band-1", "", "SBTAGR11"},
            {57, "simulated brightness temperature for nadir abi goes-r, band-1", "", "SBTAGR12"},
            {58, "simulated brightness temperature for nadir abi goes-r, band-1", "", "SBTAGR13"},
            {59, "simulated brightness temperature for nadir abi goes-r, band-1", "", "SBTAGR14"},
            {60, "simulated brightness temperature for nadir abi goes-r, band-1", "", "SBTAGR15"},
            {61, "simulated brightness temperature for nadir abi goes-r, band-1", "", "SBTAGR16"},
        ...
        {"4.10", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {1, "scintillation index s", "", "SCIDEXS4"},
            {2, "rate of change of tec index", "TECU/min", "ROTIDX"},
            {3, "disturbance ionosphere index spatial gradien", "", "DIDXSG"},
        ...
        {"10.0", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {16, "coefficient of drag with wave", "", "CDWW"},
            {17, "friction velocity", "m s-1", "FRICVW"},
            {18, "wave stress", "N m-2", "WSTR"},
            {19, "normalised waves stres", "", "NWSTR"},
            {20, "mean square slope of wave", "", "MSSW"},
            ...
            {26, "inverse mean frequency of the wind wav", "s", "IMFWW"},
            {27, "inverse mean frequency of the total swell", "s", "IMFTSW"},
            {28, "mean zero-crossing wave period", "s", "MZWPER"},
            {29, "mean zero-crossing period of the wind wav", "s", "MZPWW"},
            {30, "mean zero-crossing period of the total swell", "s", "MZPTSW"},
            {31, "wave directional widt", "", "WDIRW"},
            {32, "directional width of the wind wave", "", "DIRWWW"},
            {33, "directional width of the total swel", "", "DIRWTS"},
            {34, "peak wave period", "s", "PWPER"},
            {35, "peak period of the wind wav", "s", "PPERWW"},
            {36, "peak period of the total swell", "s", "PPERTS"},
            {37, "altimeter wave height", "m", "ALTWH"},
            {38, "altimeter corrected wave height", "m", "ALCWH"},
            {39, "altimeter range relative correctio", "", "ALRRC"},
            ...
            {43, "kurtosis of the sea surface elevation due to wave", "", "KSSEW"},
            {44, "benjamin-feir inde", "", "BENINX"},
            ...
            {56, "wave directional width of first swell partitio", "", "WDWFSWEL"},
            {57, "wave directional width of second swell partitio", "", "WDWSSWEL"},
            {58, "wave directional width of third swell partitio", "", "WDWTSWEL"},
            {59, "wave frequency width of first swell partitio", "", "WFWFSWEL"},
            {60, "wave frequency width of second swell partitio", "", "WFWSSWEL"},
            {61, "wave frequency width of third swell partitio", "", "WFWTSWEL"},
            {62, "wave frequency widt", "", "WAVEFREW"},
            {63, "frequency width of wind wave", "", "FREWWW"},
            {64, "frequency width of total swel", "", "FREWTSW"},
            ...
            {98, "goda peakedness facto", "", "GODAPEAK"},
            {99, "benjamin-feir index 2", "", "BFI2D"},
            {100, "crest-trough correlatio", "", "CTCORR"},
        ...
        {"10.2", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {28, "melt onset dat", "", "MLTDATE"},
            {29, "freeze onset dat", "", "FRZDATE"},
            {30, "sea ice breakup memor", "", "SICEBM"},
        ...
        {"10.3", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {2, "heat exchange coefficien", "", "CH"},
            {3, "practical salinit", "", "PRACTSAL"},
            ...
            {203, "heat exchange coefficien", "", "LCH"},
            {204, "freezing spra", "", "FRZSPR"},
        ...
        {"10.4", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {11, "shape factor with respect to salinity profil", "", "SFSALP"},
            {12, "shape factor with respect to temperature profile in thermoclin", "", "SFTMPP"},
        ...
        {"20.4", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            {1, "downburs", "", "DBURSTHI"},
            {2, "lightnin", "", "LTNGHI"},
            {3, "thunderstor", "", "TSTMHI"},
            {4, "coastal floo", "", "COASTFLDHI"},
            {5, "estuarine floo", "", "ESTFLDHI"},
            {6, "flash floo", "", "FFLDHI"},
            {7, "fluvial floo", "", "FLUVFLDHI"},
            {8, "groundwater floo", "", "GFLDHI"},
            {9, "ice-jam flood including debri", "", "IJFLDHI"},
            {10, "ponding floo", "", "PFLDHI"},
            {11, "snowmelt floo", "", "SMFLDHI"},
            {12, "surface water floodin", "", "SWFLDHI"},
            {13, "glacial lake outburst floo", "", "GLOFLDHI"},
            {14, "black carbo", "", "BCHI"},
            {15, "dust storm or sandstor", "", "DSTMHI"},
            {16, "fo", "", "FOGHI"},
            {17, "haz", "", "HZHI"},
            {18, "polluted ai", "", "POLAIRHI"},
            {19, "sand haz", "", "SAHZHI"},
            {20, "smok", "", "SMOKEHI"},
            {21, "ocean acidificatio", "", "OAHI"},
            {22, "rogue wav", "", "RWAVEHI"},
            {23, "sea water intrusio", "", "SWIHI"},
            {24, "sea ic", "", "SICEHI"},
            {25, "ice flo", "", "ICEFLOWHI"},
            {26, "seich", "", "SEICHEHI"},
            {27, "storm surg", "", "SURGEHI"},
            {28, "storm tide", "", "STMTIDEHI"},
            {29, "tsunam", "", "TSUNAMIHI"},
            {30, "depression or cyclon", "", "DEPRESHI"},
            {31, "extra-tropical cyclon", "", "ECPRESHI"},
            {32, "sub-tropical cyclon", "", "SUBTCPRESHI"},
            {33, "acid rai", "", "ACIDRAINHI"},
            {34, "blizzar", "", "BLIZHI"},
            {35, "drough", "", "DRTHI"},
            {36, "hai", "", "HAILHI"},
            {37, "ice stor", "", "ICESTMHI"},
            {38, "sno", "", "SNOWHI"},
            {39, "snowstor", "", "SNOWSTMHI"},
            {40, "cold wav", "", "CWAVEHI"},
            {41, "dzu", "", "DZUDHI"},
            {42, "freez", "", "FRZHI"},
            {43, "fros", "", "FROSTHI"},
            {44, "freezing rai", "", "FRZRHI"},
            {45, "glaz", "", "GLAZEHI"},
            {46, "ground fros", "", "GFROSTHI"},
            {47, "heatwav", "", "HWAVEHI"},
            {48, "icin", "", "ICINGHI"},
            {49, "tha", "", "THAWHI"},
            {50, "avalanch", "", "AVALHI"},
            {51, "mud flo", "", "MUDFLOWHI"},
            {52, "rock slid", "", "RSLIDEHI"},
            {53, "derech", "", "DERECHOHI"},
            {54, "gal", "", "GALEHI"},
            {55, "squal", "", "SQLNHI"},
            {56, "subtropical stor", "", "SSTMHI"},
            {57, "tropical cyclon", "", "TCWINDHI"},
            {58, "tropical stor", "", "TSWINDHI"},
            {59, "tornad", "", "TORHI"},
            {60, "win", "", "WINDHI"},
            {255, "missi", "", ""},
        }, "")},
        {"20.5", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            {1, "household air pollutio", "", "HHAIRPOLHI"},
            {2, "air pollutio", "", "AIRPOLHI"},
            {3, "ambient air pollutio", "", "AAIRPOLHI"},
            {4, "land degradatio", "", "LANDDEGHI"},
            {5, "soil degradatio", "", "SOILDEGHI"},
            {6, "runoff / nonpoint source pollutio", "", "RUNOFFHI"},
            {7, "salinit", "", "SALTHI"},
            {8, "biodiversity los", "", "BDLOSSHI"},
            {9, "deforestatio", "", "DEFORESTHI"},
            {10, "forest declines and dieback", "", "FORESTDECHI"},
            {11, "forest disturbance", "", "FORESTDISHI"},
            {12, "forest invasive specie", "", "FORESTINVHI"},
            {13, "wildfire", "", "WFIREHI"},
            {14, "desertificatio", "", "DESERTHI"},
            {15, "loss of mangrove", "", "MANLOSSHI"},
            {16, "wetland loss/degradatio", "", "WETLOSSHI"},
            {17, "coral bleachin", "", "CORALBHI"},
            {18, "compressive soil", "", "COMPSOILHI"},
            {19, "soil erosio", "", "SOILEROHI"},
            {20, "coastal erosion and shoreline chang", "", "COASTEROHI"},
            {21, "permafrost los", "", "PFLOSSHI"},
            {22, "sand minin", "", "SAMINHI"},
            {23, "sea level ris", "", "SLRHI"},
            {24, "eutrophicatio", "", "EUTROPHI"},
            {255, "missi", "", ""},
        }, "")},
        {"191.0", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            {0, "stochastically perturbed parameterization tendenc", "", "SPPT"},
            {1, "stochastically perturbed parameterization", "", "SPP"},
            {2, "stochastic kinetic energy backscatte", "", "SKEB"},
            {3, "stochastic trigger of convectio", "", "STC"},
            {4, "stochastic boundary-layer humidit", "", "SHUM"},
            {5, "stochastic total tendency perturbation", "", "STTP"},
            {255, "missi", "", ""},
        }, "")},
    });
