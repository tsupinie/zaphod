...
Grib2Table<Grib2TableEntryUnitsAbbrev> Grib2TableManager::get_table_4_2(unsigned short discipline, unsigned short category) const {
    std::map<std::string, Grib2Table<Grib2TableEntryUnitsAbbrev>> tables({
        ...
        {"0.3", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {22, "Slope of Subgrid Scale Orography", "Numeric", "SSGSO"},
            {23, "Gravity Wave Dissipation", "W m-2", "GWD"},
            {24, "Anisotropy of Subgrid Scale Orography", "Numeric", "ASGSO"},
        ...
        {"0.6", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {49, "Volume Fraction of Cloud", "Numeric", "VFRCIW"},
            {50, "Fog", "%", "FOG"},
        ...
        {"0.7", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {20, "Thunderstorm Intensity Index", "See Table 4.246", "TIIDEX"},
        ...
        {"0.15", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {19, "Radar Data Quality Flag", "See Table 4.106", "RDQF"},
        ...
        {"0.19", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {217, "Supercooled Large Droplet", "See Table 4.207", "SIPD"},
            ...
            {223, "Tornado Conditional Intensity Groups", "Numeric", "CIGTOR"},
            {224, "Hail Conditional Intensity Groups", "Numeric", "CIGHAIL"},
            {225, "Wind Conditional Intensity Groups", "Numeric", "CIGWIND"},
            {226, "Total Severe Conditional Intensity Groups", "Numeric", "CIGSVR"},
        ...
        {"0.20", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {112, "Absorption Aerosol Optical Thickness", "Numeric", "SCTAOTK"},
        ...
        {"1.1", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {196, "Binary Probability of Precipitation Exceeding Average Recurrence Intervals see Code table 4.222 QPFARI", "see Code table 4.222", "QPFARI"},
            {197, "Binary Probability of Precipitation Exceeding Flash Flood Guidance Values see Code table 4.222 QPFFFG", "see Code table 4.222", "QPFFFG"},
            {255, "Missing", "", ""},
        }, "")},
        ...
        {"2.0", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {31, "Normalized Differential Vegetation Index", "Numeric", "NDVINX"},
        ...
        {"2.4", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {5, "Forest Fire Weather Index", "Numeric", "FWINX"},
            {6, "Fine Fuel Moisture Code", "Numeric", "FFMCODE"},
            {7, "Duff Moisture Code", "Numeric", "DUFMCODE"},
            {8, "Drought Code", "Numeric", "DRTCODE"},
            {9, "Initial Fire Spread Index", "Numeric", "INFSINX"},
            {10, "Fire Buildup Index", "Numeric", "FBUPINX"},
            {11, "Fire Daily Severity Rating", "Numeric", "FDSRTE"},
            {12, "Keetch-Byram Drought Index", "Numeric", "KRIDX"},
            {13, "Drought Factor", "Numeric", "DRFACT"},
            {14, "Rate of Spread", "m s-1", "RATESPRD"},
            {15, "Fire Danger index", "Numeric", "FIREDIDX"},
            {16, "Spread Component", "Numeric", "SPRDCOMP"},
            {17, "Burning Index", "Numeric", "BURNIDX"},
            ...
            {26, "Wildfire Potential", "Numeric", "WFIREPOT"},
        ...
        {"3.1", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {24, "Cosine of the Solar Zenith Angle", "Numeric", "COSOLZA"},
        ...
        {"4.10", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {1, "Scintillation Index S4", "Numeric", "SCIDEXS4"},
            {2, "Rate of Change of TEC Index", "TECU/min", "ROTIDX"},
            {3, "Disturbance Ionosphere Index Spatial Gradient", "Numeric", "DIDXSG"},
        ...
        {"10.0", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            ...
            {99, "Benjamin-Feir Index 2D", "Numeric", "BFI2D"},
        ...
        {"20.4", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            {1, "Downburst", "See Table 4.253", "DBURSTHI"},
            {2, "Lightning", "See Table 4.253", "LTNGHI"},
            {3, "Thunderstorm", "See Table 4.253", "TSTMHI"},
            {4, "Coastal Flood", "See Table 4.253", "COASTFLDHI"},
            {5, "Estuarine Flood", "See Table 4.253", "ESTFLDHI"},
            {6, "Flash Flood", "See Table 4.253", "FFLDHI"},
            {7, "Fluvial Flood", "See Table 4.253", "FLUVFLDHI"},
            {8, "Groundwater Flood", "See Table 4.253", "GFLDHI"},
            {9, "Ice-Jam Flood Including Debris", "See Table 4.253", "IJFLDHI"},
            {10, "Ponding Flood", "See Table 4.253", "PFLDHI"},
            {11, "Snowmelt Flood", "See Table 4.253", "SMFLDHI"},
            {12, "Surface Water Flooding", "See Table 4.253", "SWFLDHI"},
            {13, "Glacial Lake Outburst Flood", "See Table 4.253", "GLOFLDHI"},
            {14, "Black Carbon", "See Table 4.253", "BCHI"},
            {15, "Dust Storm or Sandstorm", "See Table 4.253", "DSTMHI"},
            {16, "Fog", "See Table 4.253", "FOGHI"},
            {17, "Haze", "See Table 4.253", "HZHI"},
            {18, "Polluted Air", "See Table 4.253", "POLAIRHI"},
            {19, "Sand Haze", "See Table 4.253", "SAHZHI"},
            {20, "Smoke", "See Table 4.253", "SMOKEHI"},
            {21, "Ocean Acidification", "See Table 4.253", "OAHI"},
            {22, "Rogue Wave", "See Table 4.253", "RWAVEHI"},
            {23, "Sea Water Intrusion", "See Table 4.253", "SWIHI"},
            {24, "Sea Ice", "See Table 4.253", "SICEHI"},
            {25, "Ice Flow", "See Table 4.253", "ICEFLOWHI"},
            {26, "Seiche", "See Table 4.253", "SEICHEHI"},
            {27, "Storm Surge", "See Table 4.253", "SURGEHI"},
            {28, "Storm Tides", "See Table 4.253", "STMTIDEHI"},
            {29, "Tsunami", "See Table 4.253", "TSUNAMIHI"},
            {30, "Depression or Cyclone", "See Table 4.253", "DEPRESHI"},
            {31, "Extra-Tropical Cyclone", "See Table 4.253", "ECPRESHI"},
            {32, "Sub-Tropical Cyclone", "See Table 4.253", "SUBTCPRESHI"},
            {33, "Acid Rain", "See Table 4.253", "ACIDRAINHI"},
            {34, "Blizzard", "See Table 4.253", "BLIZHI"},
            {35, "Drought", "See Table 4.253", "DRTHI"},
            {36, "Hail", "See Table 4.253", "HAILHI"},
            {37, "Ice Storm", "See Table 4.253", "ICESTMHI"},
            {38, "Snow", "See Table 4.253", "SNOWHI"},
            {39, "Snowstorm", "See Table 4.253", "SNOWSTMHI"},
            {40, "Cold Wave", "See Table 4.253", "CWAVEHI"},
            {41, "Dzud", "See Table 4.253", "DZUDHI"},
            {42, "Freeze", "See Table 4.253", "FRZHI"},
            {43, "Frost", "See Table 4.253", "FROSTHI"},
            {44, "Freezing Rain", "See Table 4.253", "FRZRHI"},
            {45, "Glaze", "See Table 4.253", "GLAZEHI"},
            {46, "Ground Frost", "See Table 4.253", "GFROSTHI"},
            {47, "Heatwave", "See Table 4.253", "HWAVEHI"},
            {48, "Icing", "See Table 4.253", "ICINGHI"},
            {49, "Thaw", "See Table 4.253", "THAWHI"},
            {50, "Avalanche", "See Table 4.253", "AVALHI"},
            {51, "Mud Flow", "See Table 4.253", "MUDFLOWHI"},
            {52, "Rock Slide", "See Table 4.253", "RSLIDEHI"},
            {53, "Derecho", "See Table 4.253", "DERECHOHI"},
            {54, "Gale", "See Table 4.253", "GALEHI"},
            {55, "Squall", "See Table 4.253", "SQLNHI"},
            {56, "Subtropical Storm", "See Table 4.253", "SSTMHI"},
            {57, "Tropical Cyclone", "See Table 4.253", "TCWINDHI"},
            {58, "Tropical Storm", "See Table 4.253", "TSWINDHI"},
            {59, "Tornado", "See Table 4.253", "TORHI"},
            {60, "Wind", "See Table 4.253", "WINDHI"},
            {255, "Missing", "", ""},
        }, "")},
        {"20.5", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            {1, "Household Air Pollution", "See Table 4.253", "HHAIRPOLHI"},
            {2, "Air Pollution", "See Table 4.253", "AIRPOLHI"},
            {3, "Ambient Air Pollution", "See Table 4.253", "AAIRPOLHI"},
            {4, "Land Degradation", "See Table 4.253", "LANDDEGHI"},
            {5, "Soil Degradation", "See Table 4.253", "SOILDEGHI"},
            {6, "Runoff / Nonpoint Source Pollution", "See Table 4.253", "RUNOFFHI"},
            {7, "Salinity", "See Table 4.253", "SALTHI"},
            {8, "Biodiversity Loss", "See Table 4.253", "BDLOSSHI"},
            {9, "Deforestation", "See Table 4.253", "DEFORESTHI"},
            {10, "Forest Declines and Diebacks", "See Table 4.253", "FORESTDECHI"},
            {11, "Forest Disturbances", "See Table 4.253", "FORESTDISHI"},
            {12, "Forest Invasive Species", "See Table 4.253", "FORESTINVHI"},
            {13, "Wildfires", "See Table 4.253", "WFIREHI"},
            {14, "Desertification", "See Table 4.253", "DESERTHI"},
            {15, "Loss of Mangroves", "See Table 4.253", "MANLOSSHI"},
            {16, "Wetland Loss/Degradation", "See Table 4.253", "WETLOSSHI"},
            {17, "Coral Bleaching", "See Table 4.253", "CORALBHI"},
            {18, "Compressive Soils", "See Table 4.253", "COMPSOILHI"},
            {19, "Soil Erosion", "See Table 4.253", "SOILEROHI"},
            {20, "Coastal Erosion and Shoreline Change", "See Table 4.253", "COASTEROHI"},
            {21, "Permafrost Loss", "See Table 4.253", "PFLOSSHI"},
            {22, "Sand Mining", "See Table 4.253", "SAMINHI"},
            {23, "Sea Level Rise", "See Table 4.253", "SLRHI"},
            {24, "Eutrophication", "See Table 4.253", "EUTROPHI"},
            {255, "Missing", "", ""},
        }, "")},
        {"191.0", Grib2Table<Grib2TableEntryUnitsAbbrev>({
            {0, "Stochastically Perturbed Parameterization Tendency", "Numeric", "SPPT"},
            {1, "Stochastically Perturbed Parameterizations", "Numeric", "SPP"},
            {2, "Stochastic Kinetic Energy Backscatter", "Numeric", "SKEB"},
            {3, "Stochastic Trigger of Convection", "Numeric", "STC"},
            {4, "Stochastic boundary-layer Humidity", "Numeric", "SHUM"},
            {5, "Stochastic Total Tendency Perturbations", "Numeric", "STTP"},
            {255, "Missing", "", ""},
        }, "")},
    });
